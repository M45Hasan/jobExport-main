...
const ExamPaper = () => {
  ...
  const handeleStore = async (puid) => {
    await axios
      ...
      .then(async () => {
        await axios.post("/jobExpert/api/v1/myfab", {
          packageUid: puid,
          std: seletor.userData.userInfo.id,
        });
      })
                                ...
                                <div className="">
                                  <div>
                                    <div className="relative flex">
                                      ...
                                      />
                                      <label
                                        htmlFor={`question-option-${index}-optionA`}
                                        className="cursor-pointer absolute text-base top-[7px] left-[7px]"
                                      >
                                        ক
                                      </label>
                                      <p>{item.optionA}</p>
                                    ...
                                    <div className="relative flex">
                                      ...
                                      />
                                      <label
                                        htmlFor={`question-option-${index}-optionB`}
                                        className="cursor-pointer absolute text-base top-[7px] left-[7px]"
                                      >
                                        খ
                                      </label>
                                  ...
                                  <div>
                                    <div className="relative flex">
                                      ...
                                      />
                                      <label
                                        htmlFor={`question-option-${index}-optionC`}
                                        className="cursor-pointer absolute text-base top-[7px] left-[7px]"
                                      >
                                        গ
                                      </label>
                                    ...
                                    <div className="relative flex">
                                      ...
                                      />
                                      <label
                                        htmlFor={`question-option-${index}-optionD`}
                                        className="cursor-pointer absolute text-base top-[7px] left-[7px]"
                                      >
                                        ঘ
                                      </label>
